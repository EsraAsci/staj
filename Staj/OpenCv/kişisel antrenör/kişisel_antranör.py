...
pose = mpPose.Pose()
mpDraw = mp.solutions.drawing_utils #görselleştirme
...
while True:
    ...
    if results.pose_landmarks:
        ...
        for id, lm in enumerate(results.pose_landmarks.landmark): #id ve koordinatlar için
            h, w, _ = img.shape
    ...
    if len(lmList) != 0:
        ...
        per = np.interp(angle, (65, 145), (0, 100)) #açı sınırlandırma
